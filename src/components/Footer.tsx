    ...
    <footer className="bg-gray-950 text-white py-20">
      <div className="container">
        <div className="grid md:grid-cols-4 gap-12 mb-16 pb-16 border-b border-gray-800">
          <div>
            <h3 className="heading-subsection text-accent mb-4">BridgeEast</h3>
          ...
          <div>
            <h4 className="heading-card text-white mb-6">{messages.footer.explore}</h4>
          ...
          <div>
            <h4 className="heading-card text-white mb-6">{messages.footer.resources}</h4>
            <ul className="space-y-3 text-sm text-gray-300">
              <li>
          ...
          <div>
            <h4 className="heading-card text-white mb-6">{messages.footer.stayUpdated}</h4>
