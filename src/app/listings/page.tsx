    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="container section pt-32 md:pt-40 pb-14">
        <div className="max-w-3xl">
          <p className="badge mb-6">Seller Marketplace</p>
          <h1 className="mb-6">Browse expansion-ready sellers and live concept listings</h1>
          <p className="text-lg text-gray-600 leading-relaxed">
            Review seller concepts, discover who is verified, and jump into individual seller profiles to track their current expansion plans.
          </p>
        </div>
      </section>
      ...
      <section className="container pb-24">
        {loading ? (
          <div className="card p-10 text-center text-gray-500">Loading listings...</div>
        ) : (
            ...
            {listings.map((listing) => (
              <article key={listing.id} className="card flex h-full flex-col p-6">
                <div className="mb-5 flex items-start justify-between gap-4">
                  <div>
                    <p className="mb-2 text-sm font-semibold uppercase tracking-[0.18em] text-accent">{listing.category}</p>
                ...
                <p className="mb-6 flex-1 leading-relaxed text-gray-600">{listing.description}</p>
                ...
                <Link href={`/sellers/${listing.profile_id}`} className="btn-secondary text-center">
                  View Seller Profile
                </Link>
              </article>
            ))}
